...
export default function AICopilotPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "ai",
      text: "Ask me about phishing, SSL issues, SQL injection, high-risk URLs, malware, quarantine, recent events, URL scans, or vulnerability scans.",
    },
  ]);
        ...
        <main className="flex-1 p-6">
          <section className="mx-auto max-w-6xl">
            ...
            <p className="mt-2 text-sm text-slate-400">
              Ask cybersecurity questions and get simple explanations from your dashboard data.
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[320px_1fr]">
              <div className="rounded-2xl border border-cyan-400/10 bg-[#07111f]/90 p-6 shadow-[0_0_40px_rgba(34,211,238,0.05)]">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="mt-6 text-xs uppercase tracking-[0.35em] text-cyan-300">
                    EHD AI Analyst
                  </p>
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-400">
                    Database-aware assistant for scans, threats, vulnerabilities, and security events.
                  </p>

                  <button
                    onClick={speakLastAnswer}
                    disabled={!lastAnswer}
                    className="mt-6 flex items-center gap-2 rounded-xl border border-cyan-400/20 bg-cyan-500/10 px-4 py-3 text-sm text-cyan-300 transition hover:border-cyan-300/50 disabled:opacity-40"
                  >
                    <Volume2 size={17} />
                    Speak Last Answer
                  </button>
                  ...
                  <p className="mt-3 text-xs text-slate-500">
                    Voice output only. No microphone permission needed.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-cyan-400/10 bg-[#07111f]/90 p-6">
                ...
                <div className="mt-6 flex gap-3">
                  <input
                    ...
                    placeholder="Ask: Give me dashboard summary"
...
function AIOrb({
  ...
  return (
    <div className="relative flex h-72 w-72 items-center justify-center">
      <div
        className={`absolute h-64 w-64 rounded-full border border-cyan-300/20 ${
      ...
      <div className="absolute h-56 w-56 rounded-full border border-cyan-300/15 animate-pulse" />

        <div
  className={`absolute h-[210px] w-[210px] rounded-full border border-blue-300/80 shadow-[0_0_10px_rgba(59,130,246,0.9),0_0_20px_rgba(59,130,246,0.6)] ${
    loading
      ? "animate-[orbTalk_0.8s_ease-in-out_infinite]"
      : speaking
        ? "animate-[orbTalk_0.45s_ease-in-out_infinite]"
        : "animate-[orbBreathe_3s_ease-in-out_infinite]"
  }`}
/>

      <div
        className={`relative flex h-52 w-52 items-center justify-center overflow-hidden rounded-full ${
          loading
            ? "animate-[orbTalk_0.8s_ease-in-out_infinite]"
            : speaking
              ? "animate-[orbTalk_0.45s_ease-in-out_infinite]"
      ...
      >
        <div
          className={`absolute inset-0 rounded-full bg-[radial-gradient(circle_at_35%_30%,rgba(255,255,255,0.95),rgba(186,230,253,0.9)_18%,rgba(56,189,248,0.8)_36%,rgba(37,99,235,0.9)_70%,rgba(14,116,144,0.8)_100%)] ${
            loading ? "animate-pulse" : ""
          }`}
        />

        <div className="absolute -left-10 top-8 h-28 w-64 rotate-[-12deg] rounded-full bg-white/80 blur-2xl animate-pulse" />

        <div className="absolute left-0 top-20 h-28 w-64 rotate-[15deg] rounded-full bg-cyan-500/55 blur-2xl animate-pulse" />

        <div className="absolute -bottom-8 right-0 h-36 w-48 rounded-full bg-blue-800/70 blur-2xl animate-pulse" />

        <div
          className={`absolute h-56 w-56 rounded-full bg-[conic-gradient(from_180deg,rgba(255,255,255,0.25),rgba(34,211,238,0.05),rgba(37,99,235,0.3),rgba(255,255,255,0.2))] blur-xl ${
            loading ? "animate-spin" : "animate-pulse"
          }`}
        />
        ...
        <div
          className={`absolute inset-[-18px] rounded-full border border-cyan-200/15 ${
