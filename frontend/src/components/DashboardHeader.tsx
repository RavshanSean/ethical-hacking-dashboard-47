  ...
  return (
    <header className="mb-8 flex flex-col gap-4 rounded-2xl border border-green-500/20 bg-[#0b1220]/80 p-5 shadow-[0_0_40px_rgba(34,197,94,0.08)] lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="rounded-xl border border-green-500/20 bg-black p-3 text-green-400 transition hover:border-green-400 hover:shadow-[0_0_20px_rgba(34,197,94,0.25)]">
          <Bell size={20} />
        </button>
